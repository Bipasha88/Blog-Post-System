...
class BaseRepository implements IEloquentRepository{
    ...
    public function getPaginated(int $count = 2): \Illuminate\Contracts\Pagination\LengthAwarePaginator
    {
    ...
    public function getPaginatedActive(int $count = 2): \Illuminate\Contracts\Pagination\LengthAwarePaginator
    {
        return $this->newQuery()
            ->where('status','active')
            ->orderBy('created_at', 'desc')
    ...
    {
        return $this->model->orderBy ($string,$string1);
    }
